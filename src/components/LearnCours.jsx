...
function LearnCours() {
  return (
    <div className="bg-gradient-to-b from-[#C54AFF] to-[#b96edc] text-white pb-[100px] md:pb-[150px] lg:pb-[280px]">
      <h2
        data-aos="fade-up"
        data-aos-delay="0"
        className="text-center py-5 lg:mx-24 text-[24px] md:text-[40px] font-semibold text-white"
      >
